var res = {
    game_system_s_png : "res/game/system_s.png",
    ...
    mm_contnuousmatch2 : "res/effect/sound.contnuousMatch.2.mp3",
    mm_contnuousmatch3 : "res/effect/sound.contnuousMatch.3.mp3",
    mm_contnuousmatch4 : "res/effect/sound.contnuousMatch.4.mp3",
    mm_contnuousmatch5 : "res/effect/sound.contnuousMatch.5.mp3",
    mm_deadlinestep : "res/effect/sound.DeadlineStep.mp3",
    mm_bubble : "res/effect/sound.click.bubble.mp3",
    mm_drop : "res/effect/sound.Drop.mp3",
    mm_wrap : "res/effect/sound.eliminate.wrap.mp3",
    mm_break : "res/effect/sound.frosint.break.mp3",
